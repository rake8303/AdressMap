...
public class OutletMonthlySalesController extends BaseController
{
    ...
    public void export(HttpServletResponse response, OutletMonthlySales outletMonthlySales)
    {
        ...
        util.exportExcel(response, list, "monthly_sales");
    }
    ...
    @Log(title = "monthly_sales", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "monthly_sales", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "monthly_sales", businessType = BusinessType.DELETE)
