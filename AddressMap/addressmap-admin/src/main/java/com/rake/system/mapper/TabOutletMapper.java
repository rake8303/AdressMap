...
public interface TabOutletMapper 
{
    ...
    int deleteOutletMonthlySalesByOutletIds(String[] outletIds);

    int deleteOutletMonthlySalesByOutletId(@Param("outletId") String outletId);

    int batchOutletMonthlySales(List<OutletMonthlySales> monthlySalesList);
